#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Sk
...
\033[1;95m▔▔╰━╯╰━╯▔▔      ▔▔╰━╯╰━╯▔▔
\033[1;95m⊢☸☸⊢Sk⊣☸☸⊣
\033[1;95m⊢☸☸⊢I Proud To Be Sheikh⊣☸☸⊣ """
...
jalan("\033[1;93m Whatsapp +923181828187")                                  
jalan("\033[1;93m --WELCOME---TO---SK---TERMUX---COMMANDS-----")
print "\033[1;95m► ► ► ► ► ► ► ► ► ►\033[1;91mSK\033[1;95m◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄"

CorrectUsername = "Sk"
CorrectPassword = "Kami"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Sk
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;91m► ► ► ► ► ► ► ► ► ►\033[1;95mSk\033[1;91m◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄"
...
def super():
	...
	print "\033[1;97m◄►\033[1;91m> \033[1;91m2.\x1b[1;95mClone Public Account."
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;95m◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄ ◄\033[1;91mSK\033[1;95m► ► ► ► ► ► ► ► ► ►"
	print "  \033[1;91m«---◄►---Developed By SKI--◄►---»" #SKI
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Sk1.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....SK..... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Number
              \033[1;91m +923181828187"""
